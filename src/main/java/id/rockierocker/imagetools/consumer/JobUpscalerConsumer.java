...
import id.rockierocker.imagetools.dto.UpscalerResponseDto;
...
public class JobUpscalerConsumer implements MessageListener {
    ...
    public void onMessage(Message message, byte[] pattern) {
        ...
        try {
            ConsumerRequest<UpscalerResponseDto> jobMessage = objectMapper.readValue(data, new TypeReference<ConsumerRequest<UpscalerResponseDto>>() {
            });
            upscalerJobService.consumeJobResult(jobMessage);
